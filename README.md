...
- **Modern UI**: 
  ...
  - Smooth animations with particles.js background
  - Card-based layout
...
├── particles.js     # Particle animation library (full version)
├── particles.min.js # Particle animation library (minified)
